...
GO
INSERT [dbo].[Emp] ([Empno], [Ename], [Sal], [Deptno]) VALUES (1001, N'Dan', 3400, 10)
GO
INSERT [dbo].[Emp] ([Empno], [Ename], [Sal], [Deptno]) VALUES (1002, N'Bill', 4500, 20)
GO
INSERT [dbo].[Emp] ([Empno], [Ename], [Sal], [Deptno]) VALUES (1003, N'Paul', 5600, 10)
GO
INSERT [dbo].[Emp] ([Empno], [Ename], [Sal], [Deptno]) VALUES (1004, N'George', 2300, 30)
GO
